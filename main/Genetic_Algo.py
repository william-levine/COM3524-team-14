...
# Corrected by D Walker 19/09/2020 1) Fitness recalculated following insertion 
# 2) Best tour selected from population list by matching id correctly
import time
...
class GeneticAlgo(object):
    ...
    def execute(self, mapp, iterations, selection, tournament, pop_size, parent_num, next_gen, cross, cross_prob, mut_method, mut_prob):
        ...
        print(" best fittness: ", scored[0][1])
